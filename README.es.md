...
>
> **v4.0.9** hace que `getSnapshotAt()` sea totalmente independiente del reloj del sistema (antes, llamadas idénticas diferian en fracciones de arcosegundo) y sincroniza el paquete npm con el repositorio.
...
> - `getSnapshotAt(jd_tt, observer)` — API determinista explícita. Independiente del observador configurado y del reloj del sistema. Los mismos argumentos siempre producen la misma salida.
...
# 33 aserciones · 7 grupos · 0 fallos
```
...
| Independencia de getSnapshotAt respecto al reloj (v4.0.9) | Invariante: mismo jd_tt + observador = misma instantánea | 2 |
