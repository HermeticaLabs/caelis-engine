...
Caelis Engine v2.1 computes real planetary positions using professional-grade algorithms (VSOP87, ELP/MPP02), renders them as a living symbolic instrument, and exposes a complete astronomical-astrological analysis framework — in a single HTML file with zero dependencies.
...
```javascript
import { getSnapshotAt, calcEclipsesCore } from 'caelis-engine';
```
...
- [x] **npm package — caelis-engine@2.1.0 published**
...
[Download License EN (PDF)](legal/COMMERCIAL_LICENSE_EN.pdf) · [Licencia ES (PDF)](legal/COMMERCIAL_LICENSE_ES.pdf)
...
- [AstroCore API](docs/astrocore.md) — VSOP87, ELP/MPP02, coordinate transforms, eclipses, ayanamsa
- [TimeEngine API](docs/timeengine.md) — Time control, Julian dates, sidereal time
- [Atacir — Cycle Analysis](docs/atacir.md) — Primary directions, aspects, cycles, synastry, Panchanga
- [Mathematical references](docs/references.md) — Source algorithms and 107-test precision table
