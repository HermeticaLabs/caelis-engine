...
El snapshot captura el estado completo del cielo en un instante y lugar dados. Es la estructura de datos central que consumen Atacir y todos los análisis del instrumento.
...
Snapshot para una Fecha Juliana y ubicación específicas. Preserva y restaura el estado del engine sin afectar la animación en curso.
...
console.log('Sol natal:', natal.bodies.Sol.lon_ecl.toFixed(2) + '°');
console.log('Luna natal:', natal.bodies.Luna.lon_ecl.toFixed(2) + '°');
